        ...
        <div className="w-full p-6 md:w-1/2">
          <div className="mb-[67px] flex flex-col space-y-5">
            ...
            <div className="flex space-x-[10px] children:h-[30px] children:w-[30px] children:rounded-full">
              <Button className="bg-primary p-0">{''}</Button>
              <Button className="bg-success p-0">{''}</Button>
              <Button className="bg-alert p-0">{''}</Button>
              <Button className="bg-main p-0">{''}</Button>
            </div>
          </div>
          <div className="flex space-x-[10px]">
            <Button className="bg-primary px-5 py-[10px] text-sm capitalize">
              Select Options
            </Button>
            <Button
              className={clsx(
